...
G = Generator(g_conv_dim, z_dim, 38, b_dim, m_dim, dropout)
...
def train(train_loader, epoch_i):
    ...
    for data in train_loader:
        ...
        logits_real, features_real = D(label2onehot(data.x, m_dim).squeeze(1), data.edge_index)
...
torch.save(G.state_dict(), '../model/MolGAN_ZINC_G.pth')
torch.save(D.state_dict(), '../model/MolGAN_ZINC_D.pth')
torch.save(V.state_dict(), '../model/MolGAN_ZINC_V.pth')
